![docker image](https://github.com/Guillaume-Gaisne/pouet/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Guillaume-Gaisne/pouet.git
    cd pouet
    ```
    ...
    ```sh
    curl-L -o pouet.zip "https://github.com/Guillaume-Gaisne/pouet/archive/main.zip"
    unzip pouet.zip
    cd pouet
    ```
...
your `docker-compose.yaml` with `ghcr.io/guillaume-gaisne/pouet:main` for the services
...
```sh
docker pull ghcr.io/guillaume-gaisne/pouet/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Guillaume-Gaisne/pouet/manifests/main": unauthorized`
